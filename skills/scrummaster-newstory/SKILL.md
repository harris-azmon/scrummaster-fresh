...
4.  **Write Story Artifacts:**
    -   **Metadata:** Create `metadata.json` with story ID, type, status ("new"), `ready_entered_at: null`, `review_entered_at: null`, `done_at: null`, and timestamps, and optional `depends_on`/`assumes_interface` arrays.
